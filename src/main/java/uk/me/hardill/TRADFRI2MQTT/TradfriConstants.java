...
public class TradfriConstants {
	...
	public static final String DEVICES = "15001"; // not included in IPSOObjects, but this is needed everywhere
	...
	// all three are different for each color, but fixed, independent of brightness
	public static final String COLOR = "5706";
	public static final String COLOR_X = "5709";
	public static final String COLOR_Y = "5710";

	// Not from Tradfri App, extracted from CoAP communication
